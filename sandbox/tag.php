    ...
    <div id="content">
        ...
        <?php while (have_posts()) : the_post() ?>
            ...
            <div id="post-<?php the_ID() ?>">
                ...
                <div class="entry-date"><abbr class="published" title="<?php the_time('Y-m-d\TH:i:sO') ?>"><?php unset($previousday);
        printf(__('%1$s &#8211; %2$s', 'sandbox'), the_date('', '', '', false), get_the_time()) ?></abbr></div>
